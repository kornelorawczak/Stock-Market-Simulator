...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSwithdrawalENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSwithdrawalENDCLASS_t qt_meta_stringdata_CLASSwithdrawalENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "withdrawal"
        QT_MOC_LITERAL(11, 14),  // "withdrawalMade"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 6),  // "amount"
        QT_MOC_LITERAL(34, 16)   // "handleWithdrawal"
    },
    "withdrawal",
    "withdrawalMade",
    "",
...
void withdrawal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->withdrawalMade((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        case 1: _t->handleWithdrawal(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (withdrawal::*)(double );
            if (_t _q_method = &withdrawal::withdrawalMade; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void withdrawal::withdrawalMade(double _t1)
{
