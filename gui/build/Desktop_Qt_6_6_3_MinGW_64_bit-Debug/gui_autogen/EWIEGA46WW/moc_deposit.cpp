...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDepositENDCLASS_t qt_meta_stringdata_CLASSDepositENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 11),  // "depositMade"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 6)   // "amount"
    },
    "Deposit",
    "depositMade",
    "",
...
void Deposit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->depositMade((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Deposit::*)(double );
            if (_t _q_method = &Deposit::depositMade; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Deposit::depositMade(double _t1)
{
